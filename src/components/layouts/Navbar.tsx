...
const arr2 = [
  { name: "กราฟฝุ่นอาคาร 5", desc: "ประวัติค่าฝุ่น", link: "building-5" },
  { name: "กราฟฝุ่นอาคาร 6", desc: "ยังไม่เปิดให้บริการ🔴", link: "" },
  { name: "ประวัติค่าฝุ่น", desc: "ค่าฝุ่น รายวัน-เดือน-ปี", link: "previous" },
];
function Navbar() {
  return (
